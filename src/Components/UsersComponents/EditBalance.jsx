...
const EditBalance = () => {
  ...
  const handleAddType = (value) => {
    ...
    useEffect(() => {
        ...
        GetDataToUpdate({ url: `user/get-details`, cred: credentials, token: token })
            .then((res) => {
                if (res?.data?.status) {
                    setContentDetails({
                        amount: res?.data?.data?.walletBalance,
                    });
                }
            })
            .catch((error) => {
    ...
    const edit = (e) => {
        ...
        AddData({ url: "user/credit-debit-user", cred: credentials, token: token })
            .then((res) => {
                window.scrollTo(0, 0);
                setAlert({
                    successStatus: true,
                            ...
                            <div className="card-body p-md-5">
                                <div className="mb-5 col-md-2">
                                    ...
                                    <input
                                        ...
                                        value={contentDetails.amount}
                                        //onChange={handleDetails}
                                        required
                                    />
                                </div>
                                <div className="mb-5">
                                    <h5 className="mb-0 fs-exact-18">Update User Balance</h5>
                                </div>
                                {/* <form> */}
                                <div className="row">
                                    ...
                                    <div className="mb-4 col-md-6">
                                        ...
                                        <input
                                            ...
                                            name="transactionId"
                                            className="form-control"
                                            id="form-category/transactionId"
